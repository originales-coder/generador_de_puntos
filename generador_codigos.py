...
st.markdown(
    ...
    .block-container {
        ...
        padding-left: 1rem;
        padding-right: 1rem;
        max-width: 650px !important;import datetime
import json
import os
import streamlit as st
...
st.markdown(
    ...
    /* Botones grandes, granates y fáciles de tocar */
    .stButton > button {
...
# Renderizamos cada jugadora en una fila horizontal usando columnas nativas de Streamlit
for jugadora in jugadoras:
  puntos = puntos_mes[jugadora]

  # Contenedor visual de tarjeta para la fila
  st.markdown(
      """
  ...
  # Columnas nativas estrictas en una sola línea: [Nombre, Puntos, Botón Menos, Botón Más]
